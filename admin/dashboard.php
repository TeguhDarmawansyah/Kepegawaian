    ...
    <div class="container-fluid px-4">
        ...
        <div class="row g-3">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card border-0 shadow-sm h-100 bg-white">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3 text-white p-3 rounded" style="background-color: #007bff;">
                            <i class="bi bi-people fs-2"></i>
                        </div>
                        <div>
                            <h6 class="text-muted text-uppercase mb-1">Total Pegawai</h6>
                            <h4 class="mb-0 text-primary"><?= number_format($total_pegawai) ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card border-0 shadow-sm h-100 bg-white">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-3 text-white p-3 rounded" style="background-color: #0056b3;">
                            <i class="bi bi-building fs-2"></i>
                        </div>
                        <div>
                            <h6 class="text-muted text-uppercase mb-1">Total Departemen</h6>
                            <h4 class="mb-0 text-primary"><?= number_format($total_departemen) ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100 bg-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 text-primary"><?= number_format($total_jabatan) ?></h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-3 mt-3">
            <div class="col-12 col-lg-6">
                <div class="card border-0 shadow-sm h-70 bg-white">
                    <div class="card-body">
        ...
        options: {
            ...
            scales: {
                y: {
                    beginAtZero: true,
                    ticks: {
                        stepSize: 1  // Rentang sumbu Y diatur menjadi 1
                    }
                }
            },
            plugins: {
